...
int32_t search_range(Rect rect, int32_t x[], int32_t y[], int32_t w[], int32_t n) {
    ...
    for (int i = 0; i < n; i+=8) {
        ...
        res = _mm256_and_si256(_mm256_and_si256(~_mm256_cmpgt_epi32(lx, vec_x),
                                                ~_mm256_cmpgt_epi32(vec_x, rx)),
                               _mm256_and_si256(~_mm256_cmpgt_epi32(ly, vec_y),
                                                ~_mm256_cmpgt_epi32(vec_y, ry)));
